<template>
  <div class="bg-theme-1 text-white pb-md-4 pb-lg-5 pt-lg-3">
    <div class="container py-5">
      <div class="row no-gutters align-items-lg-center">
        <div class="col-lg-6 order-lg-2 text-center">
          <img
            class="img-fluid px-5 mb-4 mb-lg-0"
            width="600"
            height="400"
            src="/images/gajihub-software-payroll.png"
            alt="GajiHub Software Payroll"
          />
        </div>
        <div class="col-lg-6 order-lg-1 text-center text-lg-left">
          <h1 class="fs-1 text-break mb-3">
            Sudahi Semua Kerepotan Pengelolaan Payroll dan HR di Bisnis Anda
          </h1>
          <p class="fs-6 text-break my-3 opacity-7">
            Dengan software payroll GajiHub, Anda bisa mengelola proses penggajian dan HR
            dalam satu software terintegrasi. Hitung gaji, pajak, dan pengelolaan data
